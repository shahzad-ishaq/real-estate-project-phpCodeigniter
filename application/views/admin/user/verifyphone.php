...
<div class="admin-form">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- Widget starts -->
            <div class="widget widget-theme-color wred">
              <!-- Widget head -->
                ...
                <?php if($is_logged && $this->session->flashdata('message')!=lang_check('Thank you, phone number verified!')): ?>
                  ...
                  <?php echo form_open(NULL, array('class' => 'form-horizontal'))?>
                    ...
                    <div class="col-lg-8 col-lg-offset-4">
						<button type="submit" class="btn btn-danger themebtn"><?php echo lang_check('Send new verification message')?></button>
                        <div style="clear: both; padding-top: 3px;"> </div>
                        <button type="submit" class="btn btn-info themebtn invert"><?php echo lang_check('Confirm your verification code')?></button>
                        <br style="clear: both;" />
					</div>
                    <br style="clear: both;" />
                  <?php echo form_close()?>
