...
<div class="matter">
        ...
        <div class="row">
            <div class="col-md-12"> 
                <?php echo anchor('admin/user/edit', '<i class="icon-plus"></i>&nbsp;&nbsp;'.lang('Add a new user'), 'class="btn btn-primary themebtn"')?>
                <?php echo anchor('admin/user/export', '<i class="icon-arrow-down"></i>&nbsp;&nbsp;'.lang('Export user list'), 'class="btn btn-info themebtn"')?>
                <?php if($this->session->userdata('type') == 'ADMIN' && config_db_item('user_custom_fields_enabled') === TRUE): ?>
                    <?php echo anchor('admin/user/custom_fields/', '<i class="icon-list-alt"></i>&nbsp;&nbsp;'.lang_check('Custom fields'), 'class="btn btn-success themebtn pull-right"  style=""')?>
                <?php endif;?>
            </div>
        </div>
