        ...
        <div class="row">
            <div class="col-md-12"> 
                <?php if(!empty($user->id) && file_exists(APPPATH.'controllers/admin/reviews.php') && check_acl('reviews')): ?>
                    <?php echo anchor('admin/reviews/index/0/'.$user->id, '<i class="icon-star"></i>&nbsp;&nbsp;'.lang('Reviews'), 'class="btn btn-primary themebtn pull-right" style="margin-left:5px;"')?>
                <?php endif; ?>
            
                <?php // echo anchor('admin/user/all_user_listings/'.$user->id, '<i class="icon-remove"></i>&nbsp;&nbsp;'.lang_check('Remove all listings'), 'class="btn btn-danger themebtn invert pull-right" style="margin-left:5px;"')?>
                <?php if(check_acl('user/all_deactivate') && !empty($user->id)):?>
                <?php echo anchor('admin/user/all_deactivate/'.$user->id, '<i class="icon-remove"></i>&nbsp;&nbsp;'.lang_check('Deactivate all estates'), 'class="btn btn-danger themebtn invert pull-right" style="margin-left:5px;"')?>
                <?php echo anchor('admin/user/all_activate/'.$user->id, '<i class="icon-ok"></i>&nbsp;&nbsp;'.lang_check('Activate all estates'), 'class="btn btn-success themebtn pull-right" style="margin-left:5px;"')?>
                <?php endif;?>                
            </div>
        </div>
...
<!-- [/Custom fields] -->
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a href="<?php echo site_url('admin/user')?>" class="btn btn-default themebtn invert" type="button"><?php echo lang('Cancel')?></a>
                                  </div>
                                </div>
                       <?php echo form_close()?>
                  </div>
        ...
        <div class="col-md-12">
              ...
              <div class="widget widget-theme-color-orange worange">
