                ...
                <?php endif;?>
                  ...
                  <?php echo form_open(NULL, array('class' => 'form-horizontal'))?>
                    ...
                    <div class="col-lg-8 col-lg-offset-4">
						<button type="submit" class="btn btn-danger themebtn"><?php echo lang('Register')?></button>
						<button type="reset" class="btn btn-success themebtn invert"><?php echo lang('Reset')?></button>
					</div>
                    <br />
                  <?php echo form_close()?>
