        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="widget widget-theme-color wblue">
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                              
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-10">
                                    ...
                                    <a href="<?php echo site_url('admin/estate/forms')?>" class="btn btn-default themebtn invert" type="button"><?php echo lang('Cancel')?></a>
                                  </div>
                                </div>
                       <?php echo form_close()?>
                  </div>
