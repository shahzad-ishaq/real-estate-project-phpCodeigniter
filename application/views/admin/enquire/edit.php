                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                              
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-2 col-lg-10">
                                    <?php echo form_submit('submit', lang('Save'), 'class="btn btn-success themebtn"')?>
                                    <a href="<?php echo site_url('admin/enquire')?>" class="btn btn-primary themebtn invert" type="button"><?php echo lang('Cancel')?></a>
