...
?>
    ...
    <!-- Page heading -->
        <h2 class="pull-left"><?php echo lang('Dashboard')?>
          <!-- page meta -->
          <span class="page-meta"><?php echo "You can view at a glance.";?></span>
        </h2>
    ...
    <div class="container">
                ...
                <div class="card card1">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-10 col-xs-10">
                            ...
                            <a href="<?php echo base_url().'index.php/admin/user?smart_search=&type=AGENT';?>" class="viewall">View All</a>
                        </div>
                ...
                <div class="card card1">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-10 col-xs-10">
                            ...
                            <a href="<?php echo base_url().'index.php/admin/estate';?>" class="viewall">View All</a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-2 col-xs-2 card-icon txt-right">
                ...
                <div class="card card1">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-10 col-xs-10">
                            ...
                            <a style="visibility:hidden;" href="#" class="viewall">View All</a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-2 col-xs-2 card-icon txt-right">
                            <i class="fa fa-usd"></i>
                        </div>
        ...
        <div class="row mainbtns">
            <div class="col-md-12"> 
                <?php if(check_acl('page') && config_db_item('frontend_disabled') === FALSE):?><?php echo anchor('admin/page/edit', '<i class="icon-sitemap"></i>&nbsp;&nbsp;'.lang('Add a page'), 'class="btn c-one"')?><?php endif;?>
                <?php echo anchor('admin/estate/edit', '<i class="icon-map-marker"></i>&nbsp;&nbsp;'.lang('Add an estate'), 'class="btn btn-info c-two"')?>
            </div>
        </div>
          <div class="row">
            <div class="col-md-12">
              <div class="widget widget-theme-color  worange">
            ...
            <div class="col-md-6">
                <div class="widget widget-theme-color-orange wgreen">

                <div class="widget-head">
                  <div class="pull-left"><?php echo lang('interested_properties')?></div>
                  <div class="widget-icons pull-right">
                    <a class="wminimize" href="#"><i class="icon-chevron-up"></i></a> 
                  </div>
                  <div class="clearfix"></div>
                  ...
                  <div class="widget-content widget-pages">
                    <!-- Nested Sortable -->
                    <table class="table table-bordered footable tablet breakpoint footable-loaded">
                      <thead>
                        <tr>
                            <th>#</th>
                            ...
                            <th data-hide="phone,tablet" style="display: none;"><?php echo $row->option?></th>
                            <?php endforeach;?>
                            <!-- End dynamic generated -->
                            <th class="control footable-visible">View</th>
                      ...
                      <tbody>
                        <?php if(sw_count($fav_props)): foreach($fav_props as $fav_prop):?>
                                    <tr>
                                        <?php if($estate->is_activated == 0):?>
                                        <td><span class="label label-danger"><?php echo $fav_prop->id?></span></td>
                                        <?php else:?>
                                        <td><?php echo $fav_prop->id?></td>
                                        <?php endif;?>
                                        <td><?php echo anchor('admin/estate/edit/'.$fav_prop->id, _ch($this->estate_m->get_field_from_listing($fav_prop, 10)) )?>
                                        </td>
                                        <!-- Dynamic generated -->
                                        <?php foreach($this->option_m->get_visible($content_language_id) as $row):?>
                                        <td style="display: none;">
                                        <?php
                                            echo $this->estate_m->get_field_from_listing($fav_prop, $row->option_id);
                                        ?>
                                        </td>
                                        <?php endforeach;?>
                                        <!-- End dynamic generated -->
                                        <td><a target="_blank" href="<?php echo '/index.php/property/'.$fav_prop->id.'?preview=true'; ?>"><span class="btn btn-success fa fa-info-circle"></span></a></td>
                                        <td><?php echo btn_edit('admin/estate/edit/'.$fav_prop->id)?></td>
                                        <?php if(check_acl('estate/delete')):?><td><?php echo btn_delete('admin/estate/delete/'.$fav_prop->id)?></td><?php endif;?>
                                    </tr>
                        <?php endforeach;?>
                        <?php else:?>
                                    <tr>
            ...
            <div class="col-md-6">
                ...
                <div class="widget-head">
                  <div class="pull-left"><?php echo lang('latest_added_properties')?></div>
                  <div class="widget-icons pull-right">
                    <a class="wminimize" href="#"><i class="icon-chevron-up"></i></a> 
                  </div>
                  <div class="clearfix"></div>
                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-bordered no-plus footable">
                      <thead>
                        <tr>
                            <th>#</th>
                            <th><?php echo "Property name";?></th>
                      ...
                      <tbody>
                        <?php if(sw_count($estates)): foreach($estates as $estate):?>
                                    <tr>
                                        ...
                                        <?php endif;?>
                                        <td><?php echo anchor('admin/estate/edit/'.$estate->id, _ch($this->estate_m->get_field_from_listing($estate, 10)) )?>
                                        </td>
                                        <!-- Dynamic generated -->
                                        <?php foreach($this->option_m->get_visible($content_language_id) as $row):?>
                                        <td>
                                        ...
                                        <?php endforeach;?>
                                        <!-- End dynamic generated -->
                                        <td><span class="row-toggle btn btn-success fa fa-info-circle"></span></td>
            ...
            <?php if(config_db_item('map_version') =='open_street'):?>  
                ...
                <?php if(sw_count($estates_all)): foreach($estates_all as $estate):?>
                   <?php
                        ...
                        if($settings_template=='local' || $settings_template=='jobworld') {
                        ...
                        foreach($this->option_m->get_visible($content_language_id) as $row):
                            ...
                            {
                                isset($value)? $data .='<div class="opt"><span class=\\"label label-warning\\">'.htmlentities(strip_tags($value), ENT_QUOTES, "UTF-8").'</span></div>':'';
                            }
                            else
                            {
                   ...
                   var marker = L.marker(
                       ...
                       {icon: L.divIcon({
                               ...
                               className: 'open_steet_map_marker',
                                <?php if($settings_template=='local' || $settings_template=='jobworld'):?>
                                   iconSize: [31, 46],
                                   popupAnchor: [5, -35],
                                   iconAnchor: [15, 45],
                                <?php else:?>
            ...
            map:{
             ...
             marker:{
                ...
                <?php if(sw_count($estates_all)): foreach($estates_all as $estate):
                   ...
                   } elseif($settings_template=='local' || $settings_template=='jobworld'){  
                    echo 'options:{ icon: "'.$marker_transparent.'", 
                                labelAnchor: new google.maps.Point(20,50),
                                labelClass: "labels-marker ",
                                labelContent: "<div class=\"marker  '.$value.'-mark-color\"><img src=\"'.$icon_url.'\"></div>"
