    ...
    <div class="containerk">
      <!-- Menu button for smallar screens -->
		<div class="navbar-header">
		  ...
		  <a href="<?php echo site_url('admin/dashboard')?>" class="navbar-brand"><img src="<?php echo base_url('admin-assets/img/company/alhafeez.png');?>" /></a>
		</div>
      <!-- Site name for smallar screens -->

      <!-- Navigation starts -->
      <nav class="collapse navbar-collapse bs-navbar-collapse admin_nav" role="navigation">     
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">            
            ...
            <ul class="dropdown-menu">
              ...
              <?php if(check_acl('settings')):?><li style="display:none;"><a href="<?php echo site_url('admin/settings')?>"><i class="icon-cogs"></i> <?php echo lang_check('Settings');?></a></li><?php endif;?>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="icon-user"></i> <?php echo lang_check('Users');?> <span   class="badge badge-warning" style="display:none;"><?php echo $this->user_m->total_unactivated();?></span> 
              </a>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="navi">
            ...
            <li class="nred c-one<?php echo (strpos($this->uri->uri_string(),'dashboard')!==FALSE || $this->uri->uri_string() == 'admin')?' current':'';?>"><a href="<?php echo site_url('admin/dashboard')?>"><i class="icon-desktop"></i> <?php echo lang_check('Dashboard');?></a></li>
            
            <?php if(check_acl('page') && config_db_item('frontend_disabled') === FALSE):?>
            <li style="display: none;" class="ngreen<?php echo (strpos($this->uri->uri_string(),'page')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/page')?>"><i class="icon-sitemap"></i> <?php echo lang_check('Pages & menu');?></a></li>
            <?php endif;?>
              ...
              <ul>
                ...
                <?php
                    if(file_exists(APPPATH.'controllers/admin/treefield.php') && $this->session->userdata('type') == 'ADMIN')
                    {
                        ...
                        {
                echo '<li style="display:none;"><a href="'.site_url('admin/treefield/edit/64').'">'.$option_treefield->{'option_'.$content_language_id}.'</a></li>';        
                        }
                        
                        $option_treefield = $CI->option_m->get_lang(79);
                        if(!empty($option_treefield) && $option_treefield->type == 'TREE')
                        {
                echo '<li style="display:none;"><a href="'.site_url('admin/treefield/edit/79').'">'.$option_treefield->{'option_'.$content_language_id}.'</a></li>';        
                        }
                    }
            ...
            <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                ...
                <?php if(check_acl('settings')):?>
                    <li style="display: none;" class="has_submenu nred<?php echo (strpos($this->uri->uri_string(),'settings')!==FALSE)?' current open':'';?>">
                      <a href="#">
                        <!-- Menu name with icon -->
            ...
            <li style="display: none;" class="ngreen<?php echo (strpos($this->uri->uri_string(),'slideshow')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/slideshow')?>"><i class="icon-picture"></i> <?php echo lang_check('Slideshow')?></a></li>
            <li style="display: none;" class="nlightblue<?php echo (strpos($this->uri->uri_string(),'statistics')!==FALSE)?' current':'';?>"><a target="_blank" href="https://www.google.com/analytics/web"><i class="icon-bar-chart"></i> <?php echo lang_check('Statistics');?></a></li>
            <?php endif;?>
            
            <?php if(check_acl('backup')):?>
            <li style="display: none;" class="norange<?php echo (strpos($this->uri->uri_string(),'backup')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/backup')?>"><i class="icon-hdd"></i> <?php echo lang_check('Backup')?></a></li>
            <?php endif;?>
            ...
            <li style="display:none;" class="has_submenu nviolet<?php echo (strpos($this->uri->uri_string(),'packages')!==FALSE)?' current open':'';?>">
                <a href="#">
                    <!-- Menu name with icon -->
              ...
              <ul>
                ...
                <?php endif; ?>
                <li style="display: none;"><a href="<?php echo site_url('admin/packages/payments')?>"><?php echo lang_check('Payments');?></a></li>
              </ul>
            </li>
            ...
            <li style="display:none;" class="nblue<?php echo (strpos($this->uri->uri_string(),'favorites')!==FALSE)?' current open':'';?>">
            ...
            <li style="display: none;" class="has_submenu nred<?php echo (strpos($this->uri->uri_string(),'monetize')!==FALSE)?' current open':'';?>">
                <a href="#">
                    <!-- Menu name with icon -->
            ...
            <li style="display:none;" class="ngreen<?php echo (strpos($this->uri->uri_string(),'savesearch')!==FALSE)?' current open':'';?>">
