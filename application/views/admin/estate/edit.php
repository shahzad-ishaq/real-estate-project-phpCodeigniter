        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if(!empty($estate->id) && file_exists(APPPATH.'controllers/admin/booking.php')): ?>
                    <?php echo anchor('admin/booking/rates?smart_search='.$estate->id, '<i class="icon-shopping-cart"></i>&nbsp;&nbsp;'.lang_check('Property rates'), 'class="btn btn-primary themebtn"')?>
                <?php endif; ?>
                <?php if(!empty($estate->id) && check_acl('estate/clone_listing')): ?>
                    <?php echo anchor('admin/estate/clone_listing/'.$estate->id, '<i class="icon-share"></i>&nbsp;&nbsp;'.lang('Clone Listing'), 'class="btn btn-primary themebtn"')?>
                <?php endif; ?>
                <?php if(!empty($estate->id) && file_exists(APPPATH.'controllers/admin/reviews.php') && check_acl('reviews')): ?>
                    <?php echo anchor('admin/reviews/index/'.$estate->id, '<i class="icon-star"></i>&nbsp;&nbsp;'.lang('Reviews'), 'class="btn btn-primary themebtn"')?>
                <?php endif; ?>
                </div>
            </div>
                                ...
                                <div class="row">
                                	...
                                	<div class="col-lg-10">
                                		<div class="inline_form_group">
			                                <div class="form-group">
			                                  <label class="control-label"><?php echo lang('Featured')?> <?php echo form_checkbox('is_featured', '1', set_value('is_featured', $estate->is_featured), 'id="inputFeatured"')?></label>
			                                </div>
			                                
			                                <div class="form-group">
			                                  <label class="control-label"><?php echo lang('Activated')?>  <?php echo form_checkbox('is_activated', '1', set_value('is_activated', $estate->is_activated), 'id="inputActivated"')?></label>
			                                </div>
			                                
			                                <div class="form-group">
			                                  <label class="control-label"><?php echo lang_check('Listing visible for public');?> <?php echo form_checkbox('is_visible', '1', set_value('is_visible', $estate->is_visible), 'id="inputVisible"')?></label>
			                                </div>
			                            </div>
		                            </div>
	                            </div>
    ...
    generate_pedigree_tree('<?php echo $val_option->id.'_'.$key; ?>');
                                ...
                                <div class="form-group">
                                  <div class="col-lg-offset-3 col-lg-9">
                                    ...
                                    <a href="<?php echo site_url('admin/estate')?>" class="btn btn-default themebtn invert" type="button"><?php echo lang('Cancel')?></a>
                                  </div>
                                </div>
                       <?php echo form_close()?>
                  </div>
            ...
            <div class="col-md-4">
              <div class="widget widget-theme-color-orange wblue">
                <div class="widget-head">
                ...
                <div class="clearfix" style="margin-top: 15px;">
                    <a href="<?php echo site_url((config_item('listing_uri')===false?'property':config_item('listing_uri')).'/'.$estate->id);?>?preview=true" target="_blank" class="btn btn-default pull-right themebtn invert"><?php echo lang_check('Preview listing');?></a>
                </div>
                <?php endif;?>
