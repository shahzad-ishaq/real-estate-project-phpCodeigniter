                        ...
                        <div class="col-sm-8">
                               <div class="widget-panel border widget-submit" id="content">
                                   <div class="widget-header header-styles">
                                    <h2 class="title"><?php echo lang_check('Listing data'); ?></h2>
                                </div> <!-- ./ title --> 
                    ...
                    <div class="col-sm-4">
                            <div class="sidebar layout2">
                                <div class="widget widget-catgs">
                                    <h3 class="widget-title"><?php echo lang_check('Location');?></h3>
                                    <div class="gmap" id="mapsAddress"></div>
                                </div><!--widget-catgs end-->

                                <div class="widget widget-catgs">
                                    <h3 class="widget-title"><?php echo lang_check('Sell or Rent quickly');?></h3>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                <div class="widget-panel border widget-submit">
                                    <div class="widget-header header-styles">
                                        <h2 class="title"><?php echo lang_check('Images'); ?></h2>
                                    </div> <!-- ./ title --> 
                                <div class="content-box">
