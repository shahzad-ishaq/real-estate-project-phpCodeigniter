...
<div class="language-menu-mobile">
    ...
    if ( ! function_exists('get_lang_menu_custom_alt'))
    {
    function get_lang_menu_custom_alt($array, $lang_code, $extra_ul_attributes = '')
        {
            $CI =& get_instance();
            $property_data = NULL;
    ...
    ?>
    <?php 
      echo get_lang_menu_custom_alt($this->language_m->get_array_by(array('is_frontend'=>1)), $this->data['lang_code'], '');
    ?>
</div><!-- /.lang menu -->
<?php endif;?>
