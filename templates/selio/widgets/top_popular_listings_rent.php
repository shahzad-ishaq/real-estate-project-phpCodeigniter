...
$top_n_estates = $this->estate_m->get_by(array('is_activated' => 1, 'language_id'=>$lang_id, 'field_4'=>lang_check('Rent')), FALSE, $last_n, 'counter_views DESC');
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="section-heading">
                    ...
                    <h3><?php echo lang_check('Real Estate for Rent');?></h3>
                </div>
            </div>
        </div>
        <div class="row">
