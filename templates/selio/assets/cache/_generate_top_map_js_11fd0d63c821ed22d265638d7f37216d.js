...
$(document).ready(function(){
    ...
    if($('#main-map').length){    
        ...
        var positron = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}{r}.png').addTo(map);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: Land--><div class=\"infobox map-box\">    <a href=\"http://alhafeez.dressbeat.com/index.php/property/46/en/20_marla_plot\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"http://alhafeez.dressbeat.com/files/strict_cache/575x5004721_starbuck_ave_high_res_screen_31%20%281%29.webp\" alt=\"20 Marla Plot\">        <div class=\"rate-info\">                    <h5>                                                5,000.00AED                                        </h5>                    <span class=\"purpose-Sale and Rent\">                Sale and Rent            </span>         </div>        <div class=\"listing-item-content\">            <h3>20 Marla Plot</h3>            <span><i class=\"la la-map-marker\"></i>Abu Dhabi</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: --><div class=\"infobox map-box\">    <a href=\"http://alhafeez.dressbeat.com/index.php/property/52/en/11_marla_house\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"http://alhafeez.dressbeat.com/files/strict_cache/575x500no_image.webp\" alt=\"11 marla house\">        <div class=\"rate-info\">                    <span class=\"purpose-\">                            </span>         </div>        <div class=\"listing-item-content\">            <h3>11 marla house</h3>            <span><i class=\"la la-map-marker\"></i>Bahawalpur</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
