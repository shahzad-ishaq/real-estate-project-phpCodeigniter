...
$(document).ready(function(){
    ...
    if($('#main-map').length){    
        ...
        var positron = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}{r}.png').addTo(map);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: House--><div class=\"infobox map-box\">    <a href=\"http://alhafeez.dressbeat.com/index.php/property/38/en/test\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"http://alhafeez.dressbeat.com/files/strict_cache/575x500no_image.webp\" alt=\"test\">        <div class=\"rate-info\">                    <h5>                                                1,234.00AED /  1,234.00AED                                        </h5>                    <span class=\"purpose-Sale\">                Sale            </span>         </div>        <div class=\"listing-item-content\">            <h3>test</h3>            <span><i class=\"la la-map-marker\"></i>lahore pakistan</span>        </div>    </a></div>", jpopup_customOptions);
