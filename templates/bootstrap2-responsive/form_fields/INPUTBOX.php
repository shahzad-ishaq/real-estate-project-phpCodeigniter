...
?>
    <input id="search_option_<?php echo $f_id.$direction; ?>" type="text" class="<?php echo $class_add; ?> form-control" style="<?php _che($field->style); ?>" placeholder="<?php echo $placeholder ?><?php echo $suf_pre; ?>" value="<?php echo search_value($f_id); ?>" />
